...
//   // block scroll only during start screen
//   useEffect(() => {
//     if (!start) {
...
//         {/* Products scroll below canvas */}
//         <Products />
//       </div>

//       {/* Website overlay when entering laptop */}
//       {enterWebsite && (
...
export default function App() {
  ...
  const overlayRef = useRef(null);
  const goBackRef = useRef(null);
  const mainPageRef = useRef(null); // ← new ref for scroll container
    ...
    <>
      ...
      {start && !explore && !focusLaptop && (
        <Hero
          ...
          scrollRef={mainPageRef} // ← pass ref to Hero
        />
      )}
